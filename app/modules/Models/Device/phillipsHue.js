    ...
    getKeyboardForAction: function(act){
      ...
      switch(act) {
        case "switchOn":
          ...
          var v = {"type": "action", "deviceType":"7", "methodName":"setWhite", "target": {"iid": "X", "type": "mandatory"}, "args": [], "iid": "X", "phrase": $.i18n.t("language.turn-on-lamp-action")};
          $(btn).attr("json", JSON.stringify(v));
          break;
        case "switchOff":
          $(btn).append("<span data-i18n='keyboard.turn-off-lamp-action'/>");
          var v = {"type": "action", "methodName":"Off", "target": {"iid": "X", "type": "mandatory"}, "args": [], "iid": "X", "phrase": $.i18n.t("language.turn-off-lamp-action")};
          $(btn).attr("json", JSON.stringify(v));
          break;
        case "blink":
          $(btn).append("<span data-i18n='keyboard.blink-lamp-action'/>");
          var v = {"type": "action", "methodName":"blink", "target": {"iid": "X", "type": "mandatory"}, "args": [], "iid": "X", "phrase": $.i18n.t("language.blink-lamp-action")};
          $(btn).attr("json", JSON.stringify(v));
          break;          
        default:
    ...
    getKeyboardForEvent: function(evt){
      ...
      switch(evt) {
        case "switchOn":
          ...
          var v = {"type": "event", "eventName": "state", "source": {"iid": "X", "type": "mandatory"}, "eventValue": "true", "iid": "X", "phrase": $.i18n.t("language.turned-on-lamp-event")};
          $(btn).attr("json", JSON.stringify(v));
          break;
        case "switchOff":
          $(btn).append("<span data-i18n='keyboard.is-turned-off-lamp-event'><span>");
          var v = {"type": "event", "eventName": "state", "source": {"iid": "X", "type": "mandatory"}, "eventValue": "false", "iid": "X", "phrase": $.i18n.t("language.turned-off-lamp-event")};
          $(btn).attr("json", JSON.stringify(v));
          break;
        default:
    ...
    getKeyboardForState: function(state){
      ...
      switch(state) {
        case "isOn":
          ...
          var v = {"type": "state", "name": "isOn", "object": {"iid": "X", "type": "mandatory"}, "iid": "X", "phrase": $.i18n.t("language.is-turned-on-lamp-status")};
          $(btn).attr("json", JSON.stringify(v));
          break;
        case "isOff":
          $(btn).append("<span data-i18n='keyboard.is-turned-off-lamp-state'><span>");
          var v = {"type": "state", "name": "isOff", "object": {"iid": "X", "type": "mandatory"}, "iid": "X", "phrase": $.i18n.t("language.is-turned-off-lamp-status")};
          $(btn).attr("json", JSON.stringify(v));
          break;
        default:
