define( [
  ...
  var DragManager = {
    ...
    addDraggable:function (node, conf) {
      ...
      objDraggable.tabDepend = new Array(); // The closest descendants nodes that are also draggable
      // Dependencies
    ...
    updateInteraction:function (idPtr, x, y) {
      ...
      for(var j=0; j<this.TabDraggable[i].tabDepend.length; j++) {
        ...
        var idPtr = this.TabDraggable[index_child].idPtr1;
        this.updateInteraction(idPtr, px, py);
      }
