define( function() {
			...
			var AppsGateUtils = {
				  generateSubscribers : function(C, name) {
					 C['initSubscribers'+name] = function() {this['L_CB_'+name] = {};}
					 C['Subscribe'+name] = function(id, CB) {this['L_CB_'+name][id] = CB;}
					 C['UnSubscribe'+name] = function(id) {delete this['L_CB_'+name][id];}
